...
class AllPhotoLoadStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<AllPhotoLoadStateAdapter.LoadStateViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        loadState: LoadState
    ): AllPhotoLoadStateAdapter.LoadStateViewHolder {
    ...
    override fun onBindViewHolder(
        holder: AllPhotoLoadStateAdapter.LoadStateViewHolder,
        loadState: LoadState
    ) {
