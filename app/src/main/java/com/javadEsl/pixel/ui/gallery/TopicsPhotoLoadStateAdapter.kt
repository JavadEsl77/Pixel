...
class TopicsPhotoLoadStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<TopicsPhotoLoadStateAdapter.LoadStateViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        loadState: LoadState
    ): TopicsPhotoLoadStateAdapter.LoadStateViewHolder {
    ...
    override fun onBindViewHolder(
        holder: TopicsPhotoLoadStateAdapter.LoadStateViewHolder,
        loadState: LoadState
    ) {
